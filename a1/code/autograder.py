...
if test_min_moves:
    ...
    correct_min_moves = [2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 3, 7, 10, 14, 14, 17, 24,
                         28, 31, 29];
...
if test_alternate:
    ...
    solved = 0;
    unsolved = [];
    timebound = 120 # time limit

    PROBLEMS = TESTPROBLEMS[20:40]
    # print(PROBLEMS[10].print_state())
...
if test_anytime_gbfs:
    ...
    for i in range(0, len(PROBLEMS)):
        ...
        if not final2 and not final1:
            ...
            same += 1
            print(
                "Problem {}: same with more time (length {} vs. {}).".format(i,
                                                                             final1.gval,
                                                                             final2.gval))
        elif final2.gval < final1.gval:
            improved += 1
...
if test_anytime_weighted_astar:
    ...
    for i in range(0, len(PROBLEMS)):
        ...
        s0 = PROBLEMS[i]  # Problems get harder as i gets bigger
        weight = 100
        final1 = anytime_weighted_astar(s0, heur_fn=heur_min_moves,
                                        weight=weight, timebound=timebound1)
        final2 = anytime_weighted_astar(s0, heur_fn=heur_min_moves,
                                        weight=weight, timebound=timebound2)
